        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid sm:grid-cols-2 gap-6">
            <div className="space-y-2">
              <Label htmlFor="artistName">
                Artist / Band Name <span className="text-destructive">*</span>
              </Label>
              <Input
                id="artistName"
                name="artistName"
            ...
            <div className="space-y-2">
              <Label htmlFor="email">
                Email {!user && <span className="text-destructive">*</span>}
              </Label>
              <Input
                id="email"
                name="email"
          ...
          <div className="pt-4">
            <Button 
              type="submit" 
              size="lg" 
              className="w-full text-lg py-6 glow-purple hover:glow-purple-strong transition-all duration-300"
